...
# Accumulo
ACCUMULO_NAME=accumulo
ACCUMULO_RELNOTES_NAME=Apache Accumulo
ACCUMULO_PKG_NAME=accumulo
ACCUMULO_BASE_VERSION=1.3.5-incubating
ACCUMULO_PKG_VERSION=1.3.5
ACCUMULO_RELEASE_VERSION=1
ACCUMULO_TARBALL_DST=accumulo-$(ACCUMULO_BASE_VERSION).tar.gz
ACCUMULO_TARBALL_SRC=accumulo-$(ACCUMULO_BASE_VERSION)-src.tar.gz
ACCUMULO_SITE=$(APACHE_MIRROR)/incubator/$(ACCUMULO_NAME)/$(ACCUMULO_BASE_VERSION)/
$(eval $(call PACKAGE,accumulo,ACCUMULO))
